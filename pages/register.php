...
<?php else : ?>
	<div id="content" class="container  sidebar-full">
		...
		<!-- #primary -->
		<div class="head-banner" style="background-image: url(<?php echo home_url(); ?>/wp-content/uploads/2022/06/registration-banner.jpg);height:300px;background-size: cover;">
			<div class="container">
				<div class="inner">
				</div>
			</div>
